...
%
%  CAR2KEP         Transformation from Cartesian state to orbital elements. 
%  
...
%
% CHANGELOG:
%   18/12/2023, Andrea Barbiera:Writing code to deal appropriately with the
%                               cases of e=0 and i=0
...
if e == 0
    if v_r >=0
            theta= acos(dot(NN, rr) / (N * r));
    else  
            theta = 2 * pi - acos(dot(NN, rr) / (N * r));
    end
end
