...
% Computation of parabolic time, in order to avoid cycling for times that are equal or
% less than the parabolic time
...
% Solution: 8.7843 km/s 

%deltaVdott=2.1182 km/s 
%deltaVfbott=0.8486 km/s 
%deltaVaott=5.8175 km/s 
...
dated=[2036,5,21,0,0,0];
mjd2000d= date2mjd2000(dated);                

datefb=[2046,11,22,12,0,0];   
mjd2000fb= date2mjd2000(datefb);

datea=[2049,3,4,0,0,0];       
