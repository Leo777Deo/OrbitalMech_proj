...
% Computation of the parabolic time as a terminating value for the cycles
...
% Solution 7.9957 km/s

%deltaVdott=1.7804 km/s
%deltaVfbott=1.2375 km/s
%deltaVaott=4.9777 km/s

%          Departure: 20-12-2034
%          FLYBY:    25-6-2043
%          Arrival:   5-8-2051
...
dated=[2034,12,20,0,30,0];
mjd2000d= date2mjd2000(dated);                

datefb=[2043,6,25,0,0,0];   
mjd2000fb= date2mjd2000(datefb);

datea=[2051,8,5,0,0,0];       
